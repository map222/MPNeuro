...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.MealISILabel = QtGui.QLabel(self.layoutWidget7)
        self.MealISILabel.setObjectName(_fromUtf8("MealISILabel"))
        self.horizontalLayout_9.addWidget(self.MealISILabel)
        self.MealISIBox = QtGui.QSpinBox(self.layoutWidget7)
        self.MealISIBox.setEnabled(True)
        self.MealISIBox.setMinimum(1)
        self.MealISIBox.setMaximum(1000)
        self.MealISIBox.setProperty("value", 300)
        self.MealISIBox.setObjectName(_fromUtf8("MealISIBox"))
        self.horizontalLayout_9.addWidget(self.MealISIBox)
        self.layoutWidget8 = QtGui.QWidget(self.dockWidgetContents)
        self.layoutWidget8.setGeometry(QtCore.QRect(30, 470, 131, 22))
        ...
        self.layoutWidget_3 = QtGui.QWidget(self.dockWidgetContents)
        self.layoutWidget_3.setGeometry(QtCore.QRect(30, 430, 131, 22))
        ...
        self.MealMinLabel = QtGui.QLabel(self.layoutWidget_3)
        self.MealMinLabel.setObjectName(_fromUtf8("MealMinLabel"))
        self.horizontalLayout_11.addWidget(self.MealMinLabel)
        self.MealMinBox = QtGui.QDoubleSpinBox(self.layoutWidget_3)
        self.MealMinBox.setDecimals(2)
        self.MealMinBox.setMaximum(1.0)
        self.MealMinBox.setSingleStep(0.01)
        self.MealMinBox.setProperty("value", 0.06)
        self.MealMinBox.setObjectName(_fromUtf8("MealMinBox"))
        self.horizontalLayout_11.addWidget(self.MealMinBox)
        ...
        MainWindow.setTabOrder(self.BoutMaxBox, self.MealISIBox)
        MainWindow.setTabOrder(self.MealISIBox, self.BinSizeBox)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.MealISILabel.setText(_translate("MainWindow", "Meal IMI (s):", None))
        self.BinSizeLabel.setText(_translate("MainWindow", "Bin Size (min):", None))
        self.MealMinLabel.setText(_translate("MainWindow", "Meal min (g):", None))

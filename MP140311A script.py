...
MP140708B_feedtimes, MP140708B_watertimes, x = tp.parse_feedtimes_csv('E:\\MP_Data\\140708B\\140708B feeding.csv')
MP140709A_feedtimes, MP140709A_watertimes, x = tp.parse_feedtimes_csv('E:\\MP_Data\\140709A\\140709A feeding.csv')
MP140710A_feedtimes, MP140710A_watertimes, x = tp.parse_feedtimes_csv('E:\\MP_Data\\140710A\\140710A feeding.csv')
MP140716A_feedtimes, MP140716A_watertimes, x = tp.parse_feedtimes_csv('E:\\MP_Data\\140716A\\140716A feeding.csv')
MP140718A_feedtimes, MP140718A_watertimes, x = tp.parse_feedtimes_csv('E:\\MP_Data\\140718A\\140718A feeding.csv')
MP140722A_feedtimes, MP140722A_watertimes, x = tp.parse_feedtimes_csv('E:\\MP_Data\\140722A\\140722A feeding.csv')
MP140729B_feedtimes, MP140729B_watertimes, x = tp.parse_feedtimes_csv('E:\\MP_Data\\140729B\\140729B feeding.csv')
MP140807B_feedtimes, MP140807B_watertimes, x = tp.parse_feedtimes_csv('E:\\MP_Data\\140807B\\140807B feeding.csv')
MP140812B_feedtimes, MP140812B_watertimes, x = tp.parse_feedtimes_csv('E:\\MP_Data\\140812B\\140812B feeding.csv')
MP140813B_feedtimes, MP140813B_watertimes, x = tp.parse_feedtimes_csv('E:\\MP_Data\\140813B\\140813B feeding.csv')
MP140819B_feedtimes, MP140819B_watertimes, x = tp.parse_feedtimes_csv('E:\\MP_Data\\140819B\\140819B feeding.csv')
MP140821A_feedtimes, MP140821A_watertimes, x = tp.parse_feedtimes_csv('E:\\MP_Data\\140821A\\140821A feeding.csv')
MP140924A_feedtimes, MP140924A_watertimes, x = tp.parse_feedtimes_csv('E:\\MP_Data\\140924A\\140924A feeding.csv')
MP141010A_feedtimes, MP141010A_watertimes, x = tp.parse_feedtimes_csv('E:\\MP_Data\\141010A\\141010A feeding.csv')
MP141016B_feedtimes, MP141016B_watertimes, x = tp.parse_feedtimes_csv('E:\\MP_Data\\141016B\\141016B feeding.csv')
MP150127B_feedtimes, MP150127B_watertimes, x = tp.parse_feedtimes_csv('E:\\MP_Data\\150127B\\150127B feeding.csv')
MP150129A_feedtimes, MP150129A_watertimes, bed_times = tp.parse_feedtimes_csv('E:\\MP_Data\\150129A\\150129A feeding.csv')
MP150206A_feedtimes, MP150206A_watertimes, bed_times = tp.parse_feedtimes_csv('E:\\MP_Data\\150206A\\150206A feeding.csv')
...
for j in feedtimes:
    plt.plot(j, [max_Hz-3, max_Hz-3], color =  'k', linewidth = lw)
for w in watertimes:
    plt.plot(w, [max_Hz-1, max_Hz-1], color = 'b', linewidth = lw)
for b in bed_times_min:
    plt.plot(b, [max_Hz+2, max_Hz+2], color = 'r', linewidth = lw)
